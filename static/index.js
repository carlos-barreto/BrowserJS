...
var nextAlgoritmosCalculadosButton = document.getElementById("nextAlgoritmosCalculadosButton");
var cuadrosAlgoritmosCalculados = document.getElementById("cuadrosAlgoritmosCalculados");
var estadisticasAlgoritmosCalculados = document.getElementById("estadisticasAlgoritmosCalculados");
...
const myChartRadarCalculados = document.getElementById('myChartRadarCalculados');
...
window.onload = () => {
    ...
    const calculadasDataRadar = {
        ...
        datasets: [{
            label: 'My First Dataset',
            data: [p_minima, p_precision, duracion, p_fluidez, p_integridad, p_pronunciacion],
            fill: true,
...
function createDownloadLink(blob) {
    ...
    request.onload = () => {
        ...
        if (data.RecognitionStatus == "Success") {
            ...
            var ctx = document.getElementById("myChartRadarCalculados").getContext("2d");
